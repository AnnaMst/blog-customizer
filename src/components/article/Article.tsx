...
export const Article = ({
  ...
  return (
    <article
      ...
      <Text dynamic size={fontSize.value as unknown as 12 | 18 | 22 | 25 | 31 | 38 | 45} fontStyle='italic'>
        Фото: Hans-Peter Gauster , &quot;Bombardier CSeries CS300 HB-JCA&quot; ©
        2017 CC BY-SA 2.0
      </Text>
      <Text dynamic size={fontSize.value as unknown as 12 | 18 | 22 | 25 | 31 | 38 | 45}>
